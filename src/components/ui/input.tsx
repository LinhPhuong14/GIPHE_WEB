  ...
  ({ className, type, ...props }, ref) => {
    ...
    return (
      ...
      `,
        ...
        className="group/input rounded-full p-[2px] transition duration-300 overflow-hidden"
      >
        <input
          type={type}
          className={cn(
            `shadow-input dark:placeholder-text-neutral-600 flex h-10 w-full rounded-md 
            border-none bg-gray-50 px-3 py-2 text-sm text-black transition duration-400 
            ...
            focus-visible:outline-none disabled:cursor-not-allowed disabled:opacity-50 dark:bg-zinc-800 bg-white

...
export default function LearningReportsPage() {
  ...
  return (
    <div className="flex flex-col md:flex-row w-full h-full rounded-md border border-neutral-200 dark:border-neutral-700 dark:bg-neutral-800 mx-auto overflow-hidden">
      {/* Sidebar */}
      <DashboardSidebar isOpen={isSidebarOpen} setIsOpen={setIsSidebarOpen} />
      <div
        className={`flex flex-col mt-5 w-full transition-all duration-300 ${
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                <Card>
                  ...
                  <CardContent>
                    <div className="text-2xl font-bold">
                      {learningData.overview.totalHours} hrs
                    </div>
              ...
              >
                <Card>
                  ...
                  <CardContent>
                    <div className="text-2xl font-bold">
                      {learningData.overview.coursesCompleted}
                    </div>
                    <p className="text-xs text-muted-foreground">
                      {learningData.overview.coursesInProgress} courses in
                      progress
                    </p>
                  </CardContent>
                </Card>
              ...
              >
                <Card>
                  ...
                  <CardContent>
                    <div className="text-2xl font-bold">
                      {learningData.overview.averageScore}%
                    </div>
                    <p className="text-xs text-muted-foreground">
                      +5% from previous courses
                    </p>
                  </CardContent>
                </Card>
              </motion.div>
              ...
              >
                <Card>
                  ...
                  <CardContent>
                    <div className="text-2xl font-bold">
                      {learningData.overview.learningStreak} days
                    </div>
                    <p className="text-xs text-muted-foreground">
                      Last active: {learningData.overview.lastActive}
                    </p>
                  </CardContent>
                </Card>
              </motion.div>
          ...
          <TabsContent value="skills" className="space-y-6">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Your proficiency in different learning areas
                </CardDescription>
              </CardHeader>
              <CardContent className="space-y-6">
                {Object.entries(learningData.skills).map(
                  ([skill, value], index) => (
                    <motion.div
                      key={skill}
                ...
                <div className="space-y-4">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">
                        Practice with our AI-powered speaking exercises to
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">
                        Take our vocabulary builder course to expand your word
                        knowledge.
                      </p>
                    </div>
                  </div>
          ...
          <TabsContent value="activity" className="space-y-6">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Your learning patterns and engagement
                </CardDescription>
              </CardHeader>
              <CardContent>
                  ...
                  <div>
                    ...
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-muted-foreground">
                          Your learning consistency has improved by 15% compared
                          to last month.
                        </p>
                      </div>
                    </div>

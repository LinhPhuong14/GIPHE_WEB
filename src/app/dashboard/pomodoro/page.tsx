...
const [isSidebarOpen, setIsSidebarOpen] = useState(false)
  ...
  const [timeRemaining, setTimeRemaining] = useState(DEFAULT_SETTINGS.workDuration * 60) // in seconds
  ...
  return (
      ...
      <div className="flex min-h-screen">
        ...
        <div className={cn("flex flex-col h-full flex-1 transition-all duration-300", isSidebarOpen ? "ml-64" : "ml-25")}>
                ...
                <Card className="max-w-md mx-auto">
                  <CardHeader>
                    <div className="flex justify-between items-center">
                      ...
                      <div className="flex gap-2">
                        ...
                        <Button variant="ghost" size="sm" onClick={() => (settings.soundEnabled ? playSound() : null)}>
                  ...
                  <CardContent className="space-y-6">
                    <div className="flex justify-center">
                      <div className="text-6xl font-bold tabular-nums">{formatTime(timeRemaining)}</div>
                    </div>
                    ...
                    <div className="flex justify-center gap-2">
                      <Button
                        ...
                        onClick={() => handleChangeTimerMode("work")}
                        className="flex-1"
                      >
                        Focus
                      </Button>
                      <Button
                        ...
                        onClick={() => handleChangeTimerMode("shortBreak")}
                        className="flex-1"
                      >
                        Short Break
                      </Button>
                      <Button
                        ...
                        onClick={() => handleChangeTimerMode("longBreak")}
                        className="flex-1"
                      >
                        Long Break
                      </Button>

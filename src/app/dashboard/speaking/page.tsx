...
const speakingPrompts = [
  ...
  },
  {
    ...
    description:
      "Describe your hometown, its features, and what you like about it.",
  ...
  },
  {
    ...
    description:
      "Express your opinions on environmental problems and possible solutions.",
    difficulty: "Advanced",
    duration: "4 minutes",
    questions: [
...
export default function SpeakingPracticePage() {
  ...
  const handleSendMessage = () => {
    ...
    setTimeout(() => {
      ...
      if (currentQuestionIndex < selectedPrompt.questions.length - 1) {
        ...
        aiResponse = {
          role: "system",
          content: `Thank you for your response. ${getRandomFeedback()} Let's move on to the next question: ${
            selectedPrompt.questions[currentQuestionIndex + 1]
          }`,
        };
  ...
  return (
    <div className="flex flex-col md:flex-row w-full h-screen rounded-md border border-neutral-200 dark:border-neutral-700 dark:bg-neutral-800 mx-auto overflow-hidden">
      {/* Sidebar */}
      <DashboardSidebar />

      {/* Main Content */}
      <div className="flex flex-col items-center justify-center px-6 py-6 w-full">
        <h1 className="text-3xl font-bold text-center mb-6 text-primary">🗣️ Speaking Practice</h1>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 w-full max-w-6xl">
          ...
          <div className="lg:col-span-1">
            <Card className="shadow-lg border rounded-lg">
              <CardHeader>
                <CardTitle className="text-xl font-semibold">📝 Speaking Topics</CardTitle>
                <CardDescription className="text-muted-foreground">Select a topic to practice</CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
                {speakingPrompts.map((prompt) => (
                  ...
                  >
                    <Card
                      className={`cursor-pointer transition-all border hover:shadow-md hover:border-primary rounded-lg ${
                    ...
                    >
                      ...
                      <CardFooter className="p-5 pt-0 text-sm text-muted-foreground">
                        ⏳ Duration: <span className="font-medium">{prompt.duration}</span>
                      </CardFooter>
                    </Card>
                  </motion.div>
                ))}
                    ...
                    <div className="flex-grow flex flex-col items-center justify-center gap-6">
                      <div className="text-center">
                        ...
                        <p className="text-lg mb-6">
                          {selectedPrompt.questions[currentQuestionIndex]}
                        </p>
                      ...
                      <div className="text-center text-muted-foreground text-sm">
                        ...
                        <p>
                          The recording will automatically stop after{" "}
                          {selectedPrompt.duration}.
                        </p>
                      </div>
                    </div>
                  </TabsContent>
